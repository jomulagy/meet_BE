...
public enum ScheduledJob {
    ...
    TERMINATE_SCHEDULE_VOTE(TerminateScheduleVote.class, "0 15 22 * * ? *"),
    TERMINATE_PLACE_VOTE(TerminatePlaceVote.class, "20 15 22 * * ? *"),
    TERMINATE_PARTICIPATE_VOTE(TerminateParticipateVote.class, "0 25 0 * * ? *"),
